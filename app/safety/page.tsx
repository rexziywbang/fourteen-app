...
export default function SafetyPage() {
  return <LegalShell eyebrow="How this place works" title="Mystery without the mess." updated="August 5, 2026">
    ...
    <section><h2>No contact harvesting</h2><p>We never see your phone contacts. The manual launch collects the mobile number you enter only after clear consent. That number is never shown to another student. We do not support direct messages, photos, bios, or free text that another user can see.</p></section>
