...
export default function TermsPage() {
  return <LegalShell eyebrow="The agreement" title="Terms for being decent here." updated="August 5, 2026">
    ...
    <section><h2>Notifications</h2><p>Fourteen may send account activity through in-app notices, web push, or email. Delivery is not guaranteed, previews remain neutral, and Fourteen has no payments in this version.</p></section>
